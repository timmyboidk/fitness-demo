        ...
        <SafeAreaView className="flex-1 bg-[#121212]" edges={['top']}>
            ...
            <ScrollView className="p-4">
                ...
                <View className="bg-[#1E1E1E] rounded-2xl overflow-hidden mb-6">
                    <TouchableOpacity onPress={() => console.log("Hook: Help - Contact Service")} className="flex-row items-center justify-between p-5 border-b border-gray-800">
                ...
                {/* 协议 */}
                <View className="bg-[#1E1E1E] rounded-2xl overflow-hidden mb-6">
                    <TouchableOpacity onPress={() => console.log("Hook: Help - User Agreement")} className="flex-row items-center justify-between p-5 border-b border-gray-800">
